...
namespace TAVI_Pavlodar.Migrations
{
    ...
    [Migration("20210607091846_Loadiong3_0")]
    partial class Loadiong3_0
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TAVI_Pavlodar.Model.Loading", b =>
                {
                    ...
                    b.Property<int>("MinutesForLoading")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TAVI_Pavlodar.Model.ProductOnLoading", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TAVI_Pavlodar.Model.ProductOnLoading", b =>
                {
                    b.HasOne("TAVI_Pavlodar.Model.Loading", "loading")
                        .WithMany("Products")
